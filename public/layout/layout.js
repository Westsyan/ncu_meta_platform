...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar, .page-header').on('click', '.sidebar-toggler', function (e) {
          ...
          //  $(".left-height a").css("padding-left","15px")

            if (body.hasClass("page-sidebar-closed")) {
                $(".left-height a").removeClass("left-a-close");
                $(".left-height a").addClass("left-a-open");
                $(".platform-title").show();
                ...
                $(".left-height a").removeClass("left-a-open");
                $(".left-height a").addClass("left-a-close");
                $(".platform-title").hide();
                body.addClass("page-sidebar-closed");
